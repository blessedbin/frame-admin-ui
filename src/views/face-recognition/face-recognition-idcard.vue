<template>
  <div id="main-test-camera">
    ...
    <div>
      ...
      <el-button @click="idCardTest">读卡测试</el-button>
    </div>
    <el-row :gutter="20">
      <el-col :span="14">
        <el-card>
      ...
      <el-col :span="10">
        <el-card :body-style="{ padding: '0px' }" style="margin-right: 20px">
          <img :src="cardId.cardImage" class="image">
...
export default {
  ...
  mounted() {
    this.connect()
    this.idcard = createISSOnlineDevice()
  },
  beforeDestroy() {
  ...
  methods: {
    ...
    idCardTest() {
      if (this.idcard) {
        this.idcard.read(value => {
          console.log(value)
          this.cardId.cardImage = 'data:image/png;base64,' + value.Base64Photo
        })
      }
    }
  }
